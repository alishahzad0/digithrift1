...
class ProductPage extends React.PureComponent {
  componentDidMount() {
    ...
    this.props.fetchStoreTender(slug);
                  ...
                  <div className='item-box'>
                    ...
                    <div className='item-customize'>
                      <Input
                        ...
                        disabled={
                          product.auctionEnded || !user.verifyDocument
                        }
                    ...
                    <div className='item-actions'>
                        ...
                        /><br/><br/>
                        {!user.verifyDocument && <><span>Please Submit Document / Your Document not Verify  </span><Link to="/dashboard/document">Click here</Link></>}
                    </div>
                  </div>
                </div>
              </Col>
...
const mapStateToProps = state => {
  ...
  return {
    product: state.tender.storeAuction,
    productShopData: state.tender.productShopData,
    shopFormErrors: state.tender.shopFormErrors,
